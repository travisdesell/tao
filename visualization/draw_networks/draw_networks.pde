...
try {
    int in_iterations = 1600;
    for (int count = 0; count < 20; count++) {

      String directory = "/Users/deselt/Code/flight_analysis/aco_output/";
      String run = "aco_nhl_3_npl_8_ants_16_airspeed";
      String outname = run + "_" + in_iterations + "_" + count + ".png";
      ...
      BufferedReader br = new BufferedReader(new FileReader(directory + run + "/" + in_iterations + "_" + count));
  ...
  //          }
      ...
      System.out.println("saving to : '" + directory + outname + "'");
      save(directory + outname);
      background(255);
    }
} catch (Exception e) {
    println("EXCEPTION: " + e);
